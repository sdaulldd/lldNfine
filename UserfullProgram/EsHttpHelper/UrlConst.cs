...
namespace UserfullProgram.EsHttpHelper
{
    public static class UrlConst
    {
        ...
        /// 域名
        /// </summary>
        public static string DomainName = "https://wiki.beisen-inc.com";
        ...
        /// 登录
        /// </summary>
        public static string SignInUrl = "/dologin.action";

        /// <summary>
        /// 获取数据html
        /// </summary>
        public static string GetDataUrl = "/users/viewnotifications.action";

        /// <summary>
        /// 处理数据
        /// </summary>
        public static string SolevdUrl = "/users/removepagenotificationajax.action";
